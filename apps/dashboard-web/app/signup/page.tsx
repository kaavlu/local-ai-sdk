...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInError) {
        // If auto-signin fails (email confirmation required), show success message
  ...
  return (
    <AuthCard
      ...
      subtitle="Get started with dyno today."
    >
      ...
      <div className="mt-4 text-center">
        <span className="text-[12px] text-muted-foreground/60">Already have an account? </span>
        <Link
          href="/signin"
